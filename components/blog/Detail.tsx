...
const Badge = ({ children }) => (
  <span className='mr-2 mb-2 rounded bg-slate-200 py-1 px-2 text-xs font-medium uppercase dark:bg-slate-800'>
    {children}
  </span>
);

const Prose = ({ children }) => (
  <Box className='prose prose-lg prose-headings:font-heading prose-headings:uppercase prose-h2:text-2xl prose-h3:text-xl prose-h4:text-lg prose-a:text-green-600 Code language-js '>
    {children}
  </Box>
);
...
const Share = ({ url, title }) => (
  <Box className='flex items-center gap-2'>
    ...
    <TwitterShareButton title={title} related={['ImtiajSajin']} url={url}>
